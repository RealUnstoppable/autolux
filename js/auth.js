...
try {
    ...
    const isAutolux = window.location.hostname === 'autolux.realunstoppable.store';

    const firebaseConfig = {
        apiKey: isAutolux ? window.ENV?.AUTOLUX_FIREBASE_API_KEY : window.ENV?.FIREBASE_API_KEY,
        ...
        storageBucket: isAutolux ? "autolux-detailing.appspot.com" : (window.ENV?.FIREBASE_STORAGE_BUCKET || "demo.appspot.com"),
        messagingSenderId: isAutolux ? window.ENV?.AUTOLUX_FIREBASE_MESSAGING_SENDER_ID : window.ENV?.FIREBASE_MESSAGING_SENDER_ID,
        appId: isAutolux ? window.ENV?.AUTOLUX_FIREBASE_APP_ID : window.ENV?.FIREBASE_APP_ID
    };
    ...
    console.error("Firebase connection error. Check App Check, CORS, or config.", error.message);
