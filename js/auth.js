...
try {
    ...
    // Dynamic config based on hostname to avoid cross-contamination
    const isAutolux = window.location.hostname === 'autolux.realunstoppable.store' || window.location.hostname.includes('autolux');
