...
try {
    ...
    const firebaseConfig = {
        ...
        authDomain: isAutolux ? "autolux.realunstoppable.store" : (window.ENV?.FIREBASE_AUTH_DOMAIN || "autolux.realunstoppable.store"),
        projectId: isAutolux ? "autolux-detailing" : (window.ENV?.FIREBASE_PROJECT_ID || "autolux-detailing"),
        storageBucket: isAutolux ? "autolux-detailing.appspot.com" : (window.ENV?.FIREBASE_STORAGE_BUCKET || "autolux-detailing.appspot.com"),
