...
try {
    ...
    // Dynamic config to prevent cross-contamination
    const firebaseConfig = {
        apiKey: window.ENV?.FIREBASE_API_KEY || "dummy-api-key",
        authDomain: currentHostname === "autolux.realunstoppable.store" ? "autolux.realunstoppable.store" : (window.ENV?.FIREBASE_AUTH_DOMAIN || "autolux.realunstoppable.store"),
        projectId: currentHostname === "autolux.realunstoppable.store" ? "autolux-detailing" : (window.ENV?.FIREBASE_PROJECT_ID || "autolux-detailing"),
