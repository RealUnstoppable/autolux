...
try {
    ...
    let authDomain = window.ENV?.FIREBASE_AUTH_DOMAIN || "autolux.realunstoppable.store";
    let projectId = window.ENV?.FIREBASE_PROJECT_ID || "autolux-detailing";
    let storageBucket = window.ENV?.FIREBASE_STORAGE_BUCKET || "autolux-detailing.appspot.com";

    if (typeof window !== "undefined" && window.location && window.location.hostname) {
        if (window.location.hostname.includes("autolux")) {
            authDomain = "autolux.realunstoppable.store";
            projectId = "autolux-detailing";
            storageBucket = "autolux-detailing.appspot.com";
        } else if (window.location.hostname.includes("ezmanage")) {
            authDomain = "ezmanage.realunstoppable.store";
            projectId = "ezmanage-app";
            storageBucket = "ezmanage-app.appspot.com";
        }
    }
    ...
    console.error("Firebase connection error. Check App Check, CORS, or config.", error);
}
...
// export { app, auth, db }; // Already exported earlier
